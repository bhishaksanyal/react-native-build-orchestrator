...
```bash
yarn add -D @bhishaksanyal/react-native-build-orchestrator
```

Run without installation:

```bash
yarn dlx @bhishaksanyal/react-native-build-orchestrator init
```
