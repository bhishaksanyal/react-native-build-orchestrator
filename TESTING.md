# Testing @bhishaksanyal/react-native-build-orchestrator
...
```bash
cd /path/to/@bhishaksanyal/react-native-build-orchestrator
yarn build
yarn link
```
...
yarn link @bhishaksanyal/react-native-build-orchestrator
rnbuild --help
```
...
```bash
cd /path/to/react-native-project
yarn unlink @bhishaksanyal/react-native-build-orchestrator
